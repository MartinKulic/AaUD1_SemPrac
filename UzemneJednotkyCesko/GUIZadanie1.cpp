...
void GUIZadanie1::printError(errorType et, std::string msg="")
{
    ...
    case nespravneVstupnePar:
        ...
        GUIZadanie1::printError(VseobecnyHelp);
        SetConsoleTextAttribute(handle, 15);
...
GUIZadanie1::GUIZadanie1(const char vstupnySubor[])
{
...
void GUIZadanie1::Progressed(int by)
{
    cout << '*';
}

GUIZadanie1::~GUIZadanie1()
{
    for (Obec* o : obce)
    {
        delete o;
...
void GUIZadanie1::nacitavanie(const char vstupnySubor[])
{
    cout << "Nacitavanie: ";
...
void GUIZadanie1::startLoop()
{
    ...
    while (1)
    {
        ...
        {
            GUIZadanie1::printError(nespravneVstupnePar, operacia);
            continue;
        }
        ...
        {
            GUIZadanie1::printError(nespravneVstupnePar, kde);
        }
